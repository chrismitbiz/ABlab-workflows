...
* Some basic skills in manipulating data with the packages`dplyr`, `ggplot` and other packages in the `tidyverse`.  
...
## ILR_plotfunction
#Example on how to use it shown below
