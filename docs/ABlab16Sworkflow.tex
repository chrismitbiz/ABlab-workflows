...
\urlstyle{same}
\hypersetup{
  pdftitle={Beginner's guide to Miseq sequencing and processing of short-read microbial (16S) amplicon sequences},
  pdfauthor={Christian Krohn, PhD, RMIT University},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Beginner's guide to Miseq sequencing and processing of short-read microbial (16S) amplicon sequences}
...
\includegraphics[width=4.16667in,height=\textheight]{./img/vectorstock_23650232.jpg}
...
\chapter{Some fundamentals by Dr Jen Wood}\label{some-fundamentals-by-dr-jen-wood}

\textbf{An introduction to alpha and beta diversity analysis and the pitfalls you need to know}

By \href{https://jenwoodmicro.wordpress.com}{Dr Jen WOOD} \textbar{} Microbial community ecologist\\
\includegraphics{./img/JW.jpg}

\textbf{Microbial Diversity, how do you describe it?}
...
\textbf{Some terms and their synonyms}
...
\textbf{Definition}: Alpha diversity~is the~diversity~of each site (local species pool).

Common metrics such as Shannon-Wiener, Simpson diversity are affected by species \textbf{richness} and community \textbf{evenness}
...
\begin{itemize}
\item
  \textbf{Not} affected by the number of INDIVIDUALS (READS/ABUNDANCE).
\item
  \textbf{Not} affected by taxonomy
\end{itemize}
...
\includegraphics{./img/pond_richness.png}

\hfill\break

Two communities with an identical OTU richness of 4 but with NO species in common \includegraphics{./img/animals_richness.png}\\
...
\begin{itemize}
\item
  \textbf{IS} affected by the number of individuals (Reads/Abundance).
\item
  \textbf{Not} affected by taxonomy\\
\end{itemize}
...
\includegraphics{./img/animals_evenness.png}
...
\includegraphics[width=5.72917in,height=\textheight]{./img/petri.png}
...
\subsection{Shannon-Weiner Diversity}\label{shannon-weiner-diversity}
...
\includegraphics[width=3.64583in,height=\textheight]{./img/SW-formula.png}

\hfill\break

For this pair of communities - which is more diverse and why?

\includegraphics[width=5.72917in,height=\textheight]{./img/petri2.png}
...
\textbf{Definition}: The variation in species composition among sites.

Common metrics: (dis)similarity indices such as Bray-Curtis (BC), Unifrac, Aitchison\\
Affected by \textbf{number} of ASVs/ESVs in common, number of ASVs/ESVs not in common and similarity of shared ASV/ESV \textbf{abundances} between plots (When data is abundance weighted and not binary transformed)\\

\hfill\break
E.g. Bray-Curtis dissimilarity:\\
\includegraphics[width=1.5625in,height=\textheight]{./img/BC.jpg}\\

Where:\\
i \& j are the two sites,\\
S\textsubscript{i} is the total number of specimens counted on site i,\\
S\textsubscript{j} is the total number of specimens counted on site j,\\
C\textsubscript{ij} is the sum of only the lesser counts for each species found in both sites.\\
\strut \\

Two communities with identical richness, diversity and biomass can still be a bit dissimilar.\\
\includegraphics[width=5.72917in,height=\textheight]{./img/betatank.png}\\

\hfill\break
Two communities with identical richness, diversity and biomass can be highly dissimilar.~ \includegraphics[width=5.72917in,height=\textheight]{./img/betatank2.png}\\

\hfill\break
Changes in beta diversity may not track with changes in alpha diversity. The variation in species composition among sites can arise from \textbf{species replacement} (i.e.~community turnover) due to the tendency of species to replace each other over an ecological gradient.\\
It can also come from \textbf{species differences} (i.e.~community nestedness) due to one community having more species present than another.

\hfill\break

\subsection{Species replacement}\label{species-replacement}

\includegraphics[width=5.72917in,height=\textheight]{./img/betatank_replace.png}\\

\subsection{Species nestedness}\label{species-nestedness}

\includegraphics[width=5.72917in,height=\textheight]{./img/betatank_nest.png}\\

~

\subsection{Beta diversity analysis workflow}\label{beta-diversity-analysis-workflow}

\includegraphics{./img/betaworkflow.png}\\

\textbf{Visualisations}

\includegraphics{./img/betaviz.png}\\

\subsubsection{NMNDs and PCoA}\label{nmnds-and-pcoa}

Exactly the same data in an NMDS and in a PCoA using Bray-Curtis metric: what's the difference?

\includegraphics{./img/beta_nmdspcoa.png}

\hfill\break

\textbf{NMDS: non-Metric Multidimensional Scaling}

\includegraphics[width=3.125in,height=\textheight]{./img/beta_ordination.png}\\
...
\item
  The computer iteratively tries to project this multidimensional relationship space into 2D. If it can do this and preserve the relationships, stress \textless{} 0.2. If it can't do this stress \textgreater{} 0.2 and the ordination is basically random collection of dots.
\end{enumerate}
...
Valid if Kruskal stress values \textless{} 0.2.

\textbf{Pros:} lets the data ``speak for itself''. Way the ordination is drawn is completely analogous to the way ANOSIM/PERMANOVA stats are generated.

\textbf{Cons:} ordinations are not always valid.\\

\textbf{PCoA: Principal Coordinates analysis}

\includegraphics[width=3.125in,height=\textheight]{./img/beta_pcoa.png}\\
...
\textbf{Pros:} Always valid - no stress values; may correlate treatment effect to a tangible level of variation in the data.

\textbf{Cons:} Axis don't always explain lots of variation; communities that have ASV/ESV values that introduce large amounts of variation strongly influence the ordination, making patterns of other communities less visible; may need to remove these communities.\\

\subsubsection{Binary transform}\label{binary-transform}
...
\includegraphics[width=4.16667in,height=\textheight]{./img/binarytrans1.png}\\
\includegraphics[width=4.16667in,height=\textheight]{./img/binarytrans2.png}\\

\textbf{Example1:} Communities that share dominate species appear highly similar. What happen when we binary transform?

\includegraphics[width=5.72917in,height=\textheight]{./img/binarytranstank1.png}\\

\includegraphics[width=5.72917in,height=\textheight]{./img/binarytranstank2.png}\\

\textbf{Example2:} The communities with identical richness and biomass are \textgreater50\% dissimilar due dominant species turnover. What happens when we binary transform?

\includegraphics[width=5.72917in,height=\textheight]{./img/binarytranstank3.png}\\

\includegraphics[width=5.72917in,height=\textheight]{./img/binarytranstank4.png}\\

\subsubsection{Testing Beta diversity: Permanova}\label{testing-beta-diversity-permanova}
...
\includegraphics[width=4.16667in,height=\textheight]{./img/permanova.png}\\

PERMANOVA is not done on the output of an ordination but rather on the underlying distance matrices.

\includegraphics[width=4.16667in,height=\textheight]{./img/permaprocess.png}\\
...
\includegraphics[width=5.20833in,height=\textheight]{./img/dispersion.png}\\

\chapter{Getting started}\label{gettingstarted}

\section{Before you can analyse}\label{before-you-can-analyse}

\subsection{Get access to computational resources}\label{get-access-to-computational-resources}
...
\subsection{Get file storage}\label{get-file-storage}
...
\subsection{Learn some basic command Line}\label{learn-some-basic-command-line}
...
\subsection{Get a data storage browser}\label{get-a-data-storage-browser}
...
\subsection{Get R and R studio}\label{get-r-and-r-studio}
...
\subsection{Know what environment managers are}\label{know-what-environment-managers-are}
...
\subsection{Get a GitHub account}\label{get-a-github-account}
...
\includegraphics[width=3.125in,height=\textheight]{./img/rary.png}

We acknowledge that \textbf{rarefying data} (i.e.~the random subsampling of abundances to usually the smallest library size) results in loss of data and statistical power and is thus \textbf{not recommended for differential abundance analyses}. Check out this well cited paper here to learn why: \href{https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1003531}{Waste Not, Want Not: Why Rarefying Microbiome Data Is Inadmissible} (\citet{McMurdie2014}).

\includegraphics[width=5.9375in,height=\textheight]{./img/rary2.png}
...
\tightlist
\item
  Quality is assessed using a Nanodrop Spectrophotometer. You are aiming for \textbf{260/280 Ratio of 1.8 and a 260/230 Ratio of 2-2.2}. This is explained in the \href{https://dna.uga.edu/wp-content/uploads/sites/51/2019/02/Note-on-the-260_280-and-260_230-Ratios.pdf}{T042‐TECHNICAL BULLETIN}. The Nanodrop also estimates DNA concentrations but it is not recommended to use these concentrations measurements to normalise DNA. It is more accurate and consistent with a Qubit Fluorometer.\\
\item
...
\hline
\#SampleID & \#Sludge & \#SampleID2 & \#SampleID3 & WWTP & Digester & SludgeType & \#Primer & PrimerName & PMA\_treat & \#ExtractionID & Rep\_bio & Rep\_tech & \#SludgeSplID & Sludgecollection & SampleRequestID & \#UniqueID2\\
\hline
\#q2:types & categorical & categorical & categorical & categorical & categorical & categorical & numeric & categorical & categorical & categorical & numeric & numeric & categorical & categorical & categorical & categorical\\
\hline
PT-01 & 1 & ARCSR\_02\_Meso\_01 & ARCSR\_02\_Meso\_01V4\_UNoPMA & ETP5 & ETP5 & Meso & 1 & V4\_U & NoPMA & ARCSR\_02\_Meso\_01 & 1 & 1 & NA & 9/5/2022 & ARCSR\_02 & PT\_001\\
\hline
PT-02 & 1 & ARCSR\_02\_Meso\_02 & ARCSR\_02\_Meso\_02V4\_UNoPMA & ETP5 & ETP5 & Meso & 1 & V4\_U & NoPMA & ARCSR\_02\_Meso\_02 & 2 & 1 & NA & 9/5/2022 & ARCSR\_02 & PT\_002\\
\hline
PT-03 & 1 & ARCSR\_02\_Meso\_03 & ARCSR\_02\_Meso\_03V4\_UNoPMA & ETP5 & ETP5 & Meso & 1 & V4\_U & NoPMA & ARCSR\_02\_Meso\_03 & 3 & 1 & NA & 9/5/2022 & ARCSR\_02 & PT\_003\\
\hline
PT-04 & 1 & ARCSR\_02\_Meso\_04 & ARCSR\_02\_Meso\_04V4\_UNoPMA & ETP5 & ETP5 & Meso & 1 & V4\_U & NoPMA & ARCSR\_02\_Meso\_04 & 4 & 1 & NA & 9/5/2022 & ARCSR\_02 & PT\_004\\
\hline
PT-05 & 1 & ARCSR\_02\_Meso\_05 & ARCSR\_02\_Meso\_05V4\_UNoPMA & ETP5 & ETP5 & Meso & 1 & V4\_U & NoPMA & ARCSR\_02\_Meso\_05 & 5 & 1 & NA & 9/5/2022 & ARCSR\_02 & PT\_005\\
\hline
\end{tabular}
\end{table}
...
Following the first ASV IDs (Feature ID) and related taxon assignments in taxonomy\_silva.qza of this dataset:\\
...
\NormalTok{metadata2 }\OtherTok{\textless{}{-}}\NormalTok{ metadata[}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(metadata)),] }\SpecialCharTok{\%\textgreater{}\%}     \CommentTok{\# remove the top row (q2:types..etc)and convert characters to factors}
  ...
  \FunctionTok{column\_to\_rownames}\NormalTok{(}\StringTok{"\#SampleID"}\NormalTok{)  }\CommentTok{\# this puts the column "\#SampleID" as rownames}
...
\CommentTok{\# percent of genera identified}
\FunctionTok{ntaxa}\NormalTok{(ps.flt) }\SpecialCharTok{/} \FunctionTok{ntaxa}\NormalTok{(ps)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vegan}\SpecialCharTok{::}\FunctionTok{rarecurve}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(}\FunctionTok{t}\NormalTok{(}\FunctionTok{otu\_table}\NormalTok{(ps.flt))), }
                 \AttributeTok{step=}\DecValTok{200}\NormalTok{, }
                 \AttributeTok{sample =} \FunctionTok{min}\NormalTok{(}\FunctionTok{colSums}\NormalTok{(}\FunctionTok{otu\_table}\NormalTok{(ps.flt))), }
                 \AttributeTok{label =} \ConstantTok{FALSE}\NormalTok{, }
                 \AttributeTok{xlab =} \StringTok{"Sample Size after filtering"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}

\includegraphics{ABlab16Sworkflow_files/figure-latex/rarefaction-1.pdf}
...
\subsection{Richness}\label{richness-1}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/richness-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/shannon-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/pielou-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/plot-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/nmds-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/PCA-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/rda-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/unifrac-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/plotbeta-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/Phylumplots-1.pdf}
...
Check out the papers \href{https://www.biorxiv.org/content/10.1101/235341v2}{Phylofactorization: a graph-partitioning algorithm to identify phylogenetic scales of ecological data} (\citet{Washburne2019a}) and \href{https://peerj.com/articles/2969/}{Phylogenetic factorization of compositional data yields lineage-level associations in microbiome datasets} (\citet{Washburne2017}) to learn more about the algorithms used. Here also a great \href{https://docs.wixstatic.com/ugd/0119a1_099ae20df8424af9a38585dcebc0d45a.pdf}{Phylofactor tutorial}.
...
\CommentTok{\#                   "devtools","remotes", "colorspace", "ape"))}
...
\NormalTok{PF }\OtherTok{\textless{}{-}}\NormalTok{  phylofactor}\SpecialCharTok{::}\FunctionTok{PhyloFactor}\NormalTok{(Data,tree\_ur,X, }
        ...
        \AttributeTok{stop.early =} \ConstantTok{NULL}\NormalTok{, }
        ...
        \AttributeTok{choice =} \StringTok{"var"}\NormalTok{)  }\CommentTok{\# see notes above}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##  1 factor completed in 0.0273 minutes.    Estimated time of completion: 2024-06-17 10:56:03.331393    2 factors completed in 0.0515 minutes.     Estimated time of completion: 2024-06-17 10:56:02.143668    3 factors completed in 0.0786 minutes.     Estimated time of completion: 2024-06-17 10:56:02.498527    4 factors completed in 0.102 minutes.     Estimated time of completion: 2024-06-17 10:56:01.958609    5 factors completed in 0.126 minutes.     Estimated time of completion: 2024-06-17 10:56:01.688648    6 factors completed in 0.149 minutes.     Estimated time of completion: 2024-06-17 10:56:01.36726    7 factors completed in 0.171 minutes.     Estimated time of completion: 2024-06-17 10:56:01.124513    8 factors completed in 0.194 minutes.     Estimated time of completion: 2024-06-17 10:56:00.923488    9 factors completed in 0.217 minutes.     Estimated time of completion: 2024-06-17 10:56:00.854343    10 factors completed in 0.239 minutes.     Estimated time of completion: 2024-06-17 10:56:00.695486    11 factors completed in 0.261 minutes.     Estimated time of completion: 2024-06-17 10:56:00.579643    12 factors completed in 0.285 minutes.     Estimated time of completion: 2024-06-17 10:56:00.589503    13 factors completed in 0.309 minutes.     Estimated time of completion: 2024-06-17 10:56:00.591488   
\end{verbatim}
...
\begin{verbatim}
## # A tibble: 6 x 24
##   OTU       Kingdom Phylum Class Order Family Genus Species Phylofactor `Pr(>F)`
##   <chr>     <chr>   <chr>  <chr> <chr> <chr>  <chr> <chr>         <int>    <dbl>
## 1 59c631a4~ Bacter~ Acido~ Ther~ Ther~ Therm~ Ther~ NA                1 0       
## 2 2a4a6962~ Bacter~ Chlor~ Anae~ Anae~ Anaer~ ADur~ NA                2 3.85e-12
## 3 ea179ab2~ Bacter~ Gemma~ Gemm~ Gemm~ Gemma~ uncu~ NA                3 3.58e-10
## 4 b3ca4e33~ Bacter~ Nitro~ Nitr~ Nitr~ Nitro~ Nitr~ NA                3 3.58e-10
## 5 085bb15a~ Bacter~ Actin~ Ther~ Gaie~ uncul~ uncu~ NA                3 3.58e-10
## 6 e990f0dd~ Bacter~ Actin~ Ther~ Soli~ Solir~ Cone~ NA                3 3.58e-10
## # i 14 more variables: `(Intercept)` <dbl>, XDamhusaaen <dbl>, XEgaa <dbl>,
## #   `XEjby Moelle` <dbl>, `XEsbjerg Vest` <dbl>, XFornaes <dbl>,
## #   XHjoerring <dbl>, XMariagerfjord <dbl>, XRanders <dbl>, XSlagelse <dbl>,
## #   XSoeholt <dbl>, XViborg <dbl>, `Pr(>F)adj.` <dbl>, Abundance <dbl>
\end{verbatim}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/pfviz1-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/pfviz2-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Skip this and do the next code chunk if you just want to use the custom function}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/coloredtree-1.pdf}
...
\CommentTok{\# add taxon annotations using the factor map}
\NormalTok{p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{geom\_cladelabel}\NormalTok{(}\AttributeTok{node =} 
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/coloredtree3-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/blacktree4-1.pdf}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/ILRplotcombined-1.pdf}
...
\CommentTok{\# ploting HOW MANY GENERA are present in each phylum}
...
\includegraphics{ABlab16Sworkflow_files/figure-latex/taxafiltering-1.pdf}
