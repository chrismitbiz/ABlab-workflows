...
\CommentTok{\#ps (not run) to get an overview of number of taxa and samples contained in the phyloseq object}
\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\FunctionTok{sample\_data}\NormalTok{(ps))}
\CommentTok{\# output}
\CommentTok{\# phyloseq{-}class experiment{-}level object}
\CommentTok{\# otu\_table()   OTU Table:         [ 4218 taxa and 51 samples ]}
\CommentTok{\# sample\_data() Sample Data:       [ 51 samples by 15 sample variables ]}
...
\begin{verbatim}
##  1 factor completed in 0.0253 minutes.    Estimated time of completion: 2022-09-27 16:22:56    2 factors completed in 0.0472 minutes.     Estimated time of completion: 2022-09-27 16:22:56    3 factors completed in 0.0689 minutes.     Estimated time of completion: 2022-09-27 16:22:55    4 factors completed in 0.0908 minutes.     Estimated time of completion: 2022-09-27 16:22:55    5 factors completed in 0.111 minutes.     Estimated time of completion: 2022-09-27 16:22:55   
\end{verbatim}
...
\NormalTok{factorvector }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"Phylofactor\_1"}\NormalTok{,}\StringTok{"Phylofactor\_2"}\NormalTok{,}
                  \StringTok{"Phylofactor\_3"}\NormalTok{,}\StringTok{"Phylofactor\_4"}\NormalTok{)}
...
\CommentTok{\# Get a dataframe of phyla, and while we are at it we also count how often they appear}
\NormalTok{taxa.df.phylum }\OtherTok{\textless{}{-}}\NormalTok{ phyloseq}\SpecialCharTok{::}\FunctionTok{tax\_table}\NormalTok{(ps.phylo)}\SpecialCharTok{@}\NormalTok{.Data }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ as.data.frame }\SpecialCharTok{\%\textgreater{}\%} 
...
\NormalTok{    dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(OTUID, Phylum) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{column\_to\_rownames}\NormalTok{(}\StringTok{"OTUID"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
    \FunctionTok{count}\NormalTok{(Phylum) }\SpecialCharTok{\%\textgreater{}\%} 
...
\NormalTok{treecols }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(colorspace}\SpecialCharTok{::}\FunctionTok{rainbow\_hcl}\NormalTok{(}\FunctionTok{nrow}\NormalTok{(}\FunctionTok{unique}\NormalTok{(taxa.df.phylum))))}
\CommentTok{\# Other color options}
\CommentTok{\# treecols \textless{}{-} sample(viridis::turbo(nrow(unique(taxa.df.phylum)), direction = {-}1))}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# Get list of the abundant phyla {-} using the custom function I made available above}
\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{prevalencedf}\NormalTok{(ps.phylo, Phylum)}
\CommentTok{\# Choose the 20 most abundant Phyla for the tree}
...
\NormalTok{ordervec }\OtherTok{\textless{}{-}}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{Phylum[}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{20}\NormalTok{)]  }
...
\NormalTok{factorvector }\OtherTok{=} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{)}
...
\NormalTok{p }\OtherTok{\textless{}{-}}\NormalTok{ ggtree}\SpecialCharTok{::}\FunctionTok{ggtree}\NormalTok{(ggtree\_gps, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ Phylum), }\AttributeTok{layout =}\NormalTok{ layout, }
        \AttributeTok{branch.length =} \StringTok{"none"}\NormalTok{) }\SpecialCharTok{+} 
...
\ControlFlowTok{if}\NormalTok{ (}\FunctionTok{is.null}\NormalTok{(factorvector)) \{}
\NormalTok{  factor.map }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Phylofactor =} \DecValTok{1}\SpecialCharTok{:}\NormalTok{PF}\SpecialCharTok{$}\NormalTok{nfactors, }
                          \AttributeTok{group =} \FunctionTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{, PF}\SpecialCharTok{$}\NormalTok{nfactors))}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{  factor.map }\OtherTok{\textless{}{-}}\NormalTok{ factor.map }\SpecialCharTok{\%\textgreater{}\%} 
\NormalTok{    dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(Phylofactor }\SpecialCharTok{\%in\%}\NormalTok{ factorvector)}
\NormalTok{  \}}
...
\NormalTok{method }\OtherTok{=} \StringTok{"factors"}
\NormalTok{nd }\OtherTok{\textless{}{-}} \ConstantTok{NULL}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{m) \{}
  \ControlFlowTok{if}\NormalTok{ (method }\SpecialCharTok{==} \StringTok{"factors"}\NormalTok{) \{}
...
\NormalTok{    grp }\OtherTok{\textless{}{-}}\NormalTok{ PF}\SpecialCharTok{$}\NormalTok{tree}\SpecialCharTok{$}\NormalTok{tip.label[GroupList[[i]]]}
\NormalTok{  \}}
\NormalTok{  grp }\OtherTok{\textless{}{-}} \FunctionTok{intersect}\NormalTok{(grp, PF}\SpecialCharTok{$}\NormalTok{tree}\SpecialCharTok{$}\NormalTok{tip.label)}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{length}\NormalTok{(grp) }\SpecialCharTok{\textgreater{}} \DecValTok{0} \SpecialCharTok{\&} \FunctionTok{any}\NormalTok{(}\FunctionTok{setdiff}\NormalTok{(PF}\SpecialCharTok{$}\NormalTok{tree}\SpecialCharTok{$}\NormalTok{tip.label,grp) }\SpecialCharTok{\%in\%}\NormalTok{ PF}\SpecialCharTok{$}\NormalTok{tree}\SpecialCharTok{$}\NormalTok{tip.label)) \{}
    \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{length}\NormalTok{(grp) }\SpecialCharTok{\textgreater{}} \DecValTok{1}\NormalTok{) \{}
...
\NormalTok{    \}}
    \ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{      nd }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(nd, }\FunctionTok{match}\NormalTok{(grp, PF}\SpecialCharTok{$}\NormalTok{tree}\SpecialCharTok{$}\NormalTok{tip.label))}
\NormalTok{    \}}
\NormalTok{  \}}
\NormalTok{\}}
...
\NormalTok{p }\OtherTok{\textless{}{-}} \FunctionTok{mytreefunctionwithbarplots}\NormalTok{(PF, ps.phylo, }
         ...
         \AttributeTok{factorvector =}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{),}
...
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(Phylum }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"Proteobacteria"}\NormalTok{, }\StringTok{"Cyanobacteria"}\NormalTok{, }\StringTok{"Campilobacterota"}\NormalTok{, }\StringTok{"WPS{-}2"}\NormalTok{,}
                              \StringTok{"Acidobacteriota"}\NormalTok{,}\StringTok{"Chloroflexi"}\NormalTok{, }\StringTok{"Bacteroidota"}\NormalTok{, }\StringTok{"Fermentibacterota"}\NormalTok{)))}\SpecialCharTok{$}\NormalTok{Phylum}
\CommentTok{\# plot tree}
\NormalTok{p }\OtherTok{\textless{}{-}} \FunctionTok{mytreefunctionwithbarplots}\NormalTok{(PF, ps.phylo, }
         \AttributeTok{layout =} \StringTok{"circular"}\NormalTok{,}
         \AttributeTok{branch.length =} \StringTok{"none"}\NormalTok{,}
         \AttributeTok{factorvector =}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{),}
         \AttributeTok{offset.text =} \DecValTok{5}\NormalTok{,}
         \AttributeTok{pwidth =} \FloatTok{0.05}\NormalTok{)}
\NormalTok{p}
\end{Highlighting}
...
\includegraphics{gitbook-demo_files/figure-latex/coloredtree2-1.pdf}

And maybe manually add genus names of important factors to the figure too:

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# A small df to map the factors and groups}
\NormalTok{factor.map }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Phylofactor =} \DecValTok{1}\SpecialCharTok{:}\NormalTok{PF}\SpecialCharTok{$}\NormalTok{nfactors, }\AttributeTok{group =} \FunctionTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{, PF}\SpecialCharTok{$}\NormalTok{nfactors))}
\CommentTok{\# Then get tip labels of selected factors and groups and use as index to the taxonomy to get genus name}
\CommentTok{\# Factor 1}
\NormalTok{taxon1 }\OtherTok{\textless{}{-}}\FunctionTok{data.frame}\NormalTok{(}\FunctionTok{tax\_table}\NormalTok{(ps.phylo))[PF}\SpecialCharTok{$}\NormalTok{tree}\SpecialCharTok{$}\NormalTok{tip.label[PF}\SpecialCharTok{$}\NormalTok{groups[[factor.map[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{]]][[factor.map[}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{]]]],]}\SpecialCharTok{$}\NormalTok{Genus }
\CommentTok{\# Factor 2}
\NormalTok{taxon2 }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\FunctionTok{tax\_table}\NormalTok{(ps.phylo))[PF}\SpecialCharTok{$}\NormalTok{tree}\SpecialCharTok{$}\NormalTok{tip.label[PF}\SpecialCharTok{$}\NormalTok{groups[[factor.map[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{]]][[factor.map[}\DecValTok{2}\NormalTok{, }\DecValTok{2}\NormalTok{]]]],]}\SpecialCharTok{$}\NormalTok{Family}
\CommentTok{\# Factor 4}
\NormalTok{taxon4 }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\FunctionTok{tax\_table}\NormalTok{(ps.phylo))[PF}\SpecialCharTok{$}\NormalTok{tree}\SpecialCharTok{$}\NormalTok{tip.label[PF}\SpecialCharTok{$}\NormalTok{groups[[factor.map[}\DecValTok{4}\NormalTok{,}\DecValTok{1}\NormalTok{]]][[factor.map[}\DecValTok{4}\NormalTok{, }\DecValTok{2}\NormalTok{]]]],]}\SpecialCharTok{$}\NormalTok{Family}
\CommentTok{\# Factor 5}
\NormalTok{taxon5 }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\FunctionTok{tax\_table}\NormalTok{(ps.phylo))[PF}\SpecialCharTok{$}\NormalTok{tree}\SpecialCharTok{$}\NormalTok{tip.label[PF}\SpecialCharTok{$}\NormalTok{groups[[factor.map[}\DecValTok{5}\NormalTok{,}\DecValTok{1}\NormalTok{]]][[factor.map[}\DecValTok{5}\NormalTok{, }\DecValTok{2}\NormalTok{]]]],]}\SpecialCharTok{$}\NormalTok{Genus}
...
\CommentTok{\# add node labels to the nodes}
\NormalTok{p }\SpecialCharTok{+} \FunctionTok{geom\_cladelabel}\NormalTok{(}\AttributeTok{node =} 
\NormalTok{                 (factor.map }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(Phylofactor }\SpecialCharTok{==}  \DecValTok{1}\NormalTok{))}\SpecialCharTok{$}\NormalTok{node, }
                 \AttributeTok{label =} \FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}italic(\textquotesingle{}}\NormalTok{, taxon1,}\StringTok{\textquotesingle{})\textquotesingle{}}\NormalTok{), }
                 \AttributeTok{offset.text =} \DecValTok{25}\NormalTok{, }
                 \AttributeTok{hjust =} \StringTok{"center"}\NormalTok{,}
                 \AttributeTok{fontsize =} \DecValTok{3}\NormalTok{,}
                 \AttributeTok{parse =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{+} 
   \FunctionTok{geom\_cladelabel}\NormalTok{(}\AttributeTok{node =} 
\NormalTok{                 (factor.map }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(Phylofactor }\SpecialCharTok{==}  \DecValTok{2}\NormalTok{))}\SpecialCharTok{$}\NormalTok{node, }
                 \AttributeTok{label =} \FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}italic(\textquotesingle{}}\NormalTok{, taxon2,}\StringTok{\textquotesingle{})\textquotesingle{}}\NormalTok{), }
...
\NormalTok{                 (factor.map }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(Phylofactor }\SpecialCharTok{==}  \DecValTok{4}\NormalTok{))}\SpecialCharTok{$}\NormalTok{node, }
                 \AttributeTok{label =} \FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}italic(\textquotesingle{}}\NormalTok{, taxon4,}\StringTok{\textquotesingle{})\textquotesingle{}}\NormalTok{), }
                 \AttributeTok{offset.text =} \DecValTok{10}\NormalTok{, }
                 \AttributeTok{hjust =} \StringTok{"center"}\NormalTok{,}
                 \AttributeTok{fontsize =} \DecValTok{3}\NormalTok{,}
                 \AttributeTok{parse =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{+} 
   \FunctionTok{geom\_cladelabel}\NormalTok{(}\AttributeTok{node =} 
\NormalTok{                 (factor.map }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(Phylofactor }\SpecialCharTok{==}  \DecValTok{5}\NormalTok{))}\SpecialCharTok{$}\NormalTok{node, }
                 \AttributeTok{label =} \FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}italic(\textquotesingle{}}\NormalTok{, taxon5,}\StringTok{\textquotesingle{})\textquotesingle{}}\NormalTok{), }
