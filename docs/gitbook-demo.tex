...
\begin{verbatim}
##  1 factor completed in 0.0267 minutes.    Estimated time of completion: 2022-09-27 09:05:41    2 factors completed in 0.0484 minutes.     Estimated time of completion: 2022-09-27 09:05:40    3 factors completed in 0.0701 minutes.     Estimated time of completion: 2022-09-27 09:05:40    4 factors completed in 0.0927 minutes.     Estimated time of completion: 2022-09-27 09:05:39    5 factors completed in 0.113 minutes.     Estimated time of completion: 2022-09-27 09:05:39   
\end{verbatim}
...
\NormalTok{                 (df }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(Phylofactor }\SpecialCharTok{==}\NormalTok{ i))}\SpecialCharTok{$}\NormalTok{Phylofactor), }\AttributeTok{offset.text =}\NormalTok{ offset.text, }\AttributeTok{hjust =} \StringTok{"center"}\NormalTok{)}
\NormalTok{  \}}
\FunctionTok{rm}\NormalTok{(taxa.df.phylum, df)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# summary(PF,taxonomy,factor=1) \# Acidobacteriota}
\CommentTok{\# summary(PF,taxonomy,factor=2) \# Chloroflexi}
\CommentTok{\# summary(PF,taxonomy,factor=4) \# Bacteroidota}
\CommentTok{\# summary(PF,taxonomy,factor=5) \#Firmicutes}
...
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(Phylum }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"Proteobacteria"}\NormalTok{, }\StringTok{"Cyanobacteria"}\NormalTok{, }\StringTok{"Campilobacterota"}\NormalTok{, }\StringTok{"WPS{-}2"}\NormalTok{,}
                              \StringTok{"Acidobacteriota"}\NormalTok{,}\StringTok{"Chloroflexi"}\NormalTok{, }\StringTok{"Bacteroidota"}\NormalTok{, }\StringTok{"Firmicutes"}\NormalTok{)))}\SpecialCharTok{$}\NormalTok{Phylum}
