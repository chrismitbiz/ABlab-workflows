...
\subsubsection{Load phyloseq object}\label{load-phyloseq-object-1}}
...
\subsubsection{Check metadata contained in the phyloseq object.}\label{check-metadata-contained-in-the-phyloseq-object.}}
...
\subsubsection{Colors}\label{colors-1}}
...
\subsubsection{Pre-filtering}\label{pre-filtering}}

Some arbitrary quality filtering of individual ASVs. For example, here we choose to remove ASVs that have very few reads (i.e.~less than 5 counts of the amplicon sequence)
