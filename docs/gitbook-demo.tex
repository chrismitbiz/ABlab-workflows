...
Note that rarefying is generally not recommended for differential abundance analyses due to the loss of statistical power. Learn why here: \href{https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1003531}{Waste Not, Want Not: Why Rarefying Microbiome Data Is Inadmissible} (\citet{McKnight2019a}).
...
\item
  If you dont have your own data you can download the pre-saved \texttt{.rds} object from this Chapter and follow the below steps: \href{./ps_ProjectX_2022July}{ps\_ProjectX\_2022July} (unzip file once downloaded).
\end{itemize}
