...
\begin{verbatim}
##  1 factor completed in 0.0371 minutes.    Estimated time of completion: 2022-09-27 20:30:18    2 factors completed in 0.0692 minutes.     Estimated time of completion: 2022-09-27 20:30:17    3 factors completed in 0.101 minutes.     Estimated time of completion: 2022-09-27 20:30:17    4 factors completed in 0.133 minutes.     Estimated time of completion: 2022-09-27 20:30:17    5 factors completed in 0.163 minutes.     Estimated time of completion: 2022-09-27 20:30:16   
\end{verbatim}
...
\NormalTok{    grp }\OtherTok{\textless{}{-}}\NormalTok{ PF}\SpecialCharTok{$}\NormalTok{tree}\SpecialCharTok{$}\NormalTok{tip.label[PF}\SpecialCharTok{$}\NormalTok{groups[[factor.map[}\DecValTok{3}\NormalTok{,}\DecValTok{1}\NormalTok{]]][[factor.map[}\DecValTok{3}\NormalTok{, }\DecValTok{2}\NormalTok{]]]]}
...
\CommentTok{\# Create a df of taxa names for annotation}
...
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(tax.names)) \{}
\NormalTok{p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{geom\_cladelabel}\NormalTok{(}\AttributeTok{node =} 
\NormalTok{                 (factor.map }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(Phylofactor }\SpecialCharTok{==}\NormalTok{  i))}\SpecialCharTok{$}\NormalTok{node, }
                 \AttributeTok{label =} \FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}italic(\textquotesingle{}}\NormalTok{, tax.names[i,],}\StringTok{\textquotesingle{})\textquotesingle{}}\NormalTok{), }
