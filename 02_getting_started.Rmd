...
There are several other environment managers. We are also using [Docker](https://www.docker.com/) in our work but it take a little more learning to use it effectively.  
